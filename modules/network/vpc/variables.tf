...
variable "apps_subnet_ipv6_prefixes" {
  description = "Assigns IPv6 apps subnet id based on the Amazon provided /56 prefix base 10 integer (0-256). Must be of equal length to the corresponding IPv4 subnet list"
  type        = list
  default     = []
}

variable "ecodass_subnet_ipv6_prefixes" {
  description = "Assigns IPv6 ecodass subnet id based on the Amazon provided /56 prefix base 10 integer (0-256). Must be of equal length to the corresponding IPv4 subnet list"
  type        = list
  default     = []
}
...
variable "apps_subnet_assign_ipv6_address_on_creation" {
  description = "Assign IPv6 address on apps subnet, must be disabled to change IPv6 CIDRs. This is the IPv6 equivalent of map_public_ip_on_launch"
  type        = bool
  default     = null
}

variable "ecodass_subnet_assign_ipv6_address_on_creation" {
  description = "Assign IPv6 address on ecodass subnet, must be disabled to change IPv6 CIDRs. This is the IPv6 equivalent of map_public_ip_on_launch"
  type        = bool
  default     = null
}
...
variable "apps_subnet_suffix" {
  description = "Suffix to append to apps subnets name"
  type        = string
  default     = "apps"
}

variable "ecodass_subnet_suffix" {
  description = "Suffix to append to ecodass subnets name"
  type        = string
  default     = "ecodass"
}
...
variable "apps_subnets" {
  description = "A list of apps subnets"
  type        = list(string)
  default     = []
}

variable "ecodass_subnets" {
  description = "A list of ecodass subnets"
  type        = list(string)
  default     = []
}
...
variable "create_apps_subnet_route_table" {
  description = "Controls if separate route table for apps should be created"
  type        = bool
  default     = false
}

variable "enable_public_apps" {
  description = "Controls if apps should have public routing table"
  type        = bool
  default     = false
}

variable "create_ecodass_subnet_route_table" {
  description = "Controls if separate route table for ecodass should be created"
  type        = bool
  default     = false
}
...
variable "apps_route_table_tags" {
  description = "Additional tags for the apps route tables"
  type        = map(string)
  default     = {}
}

variable "ecodass_route_table_tags" {
  description = "Additional tags for the ecodass route tables"
  type        = map(string)
  default     = {}
}
...
variable "apps_subnet_tags" {
  description = "Additional tags for the apps subnets"
  type        = map(string)
  default     = {}
}

variable "ecodass_subnet_tags" {
  description = "Additional tags for the ecodass subnets"
  type        = map(string)
  default     = {}
}
...
variable "apps_acl_tags" {
  description = "Additional tags for the apps subnets network ACL"
  type        = map(string)
  default     = {}
}

variable "ecodass_acl_tags" {
  description = "Additional tags for the ecodass subnets network ACL"
  type        = map(string)
  default     = {}
}
...
variable "apps_dedicated_network_acl" {
  description = "Whether to use dedicated network ACL (not default) and custom rules for apps subnets"
  type        = bool
  default     = false
}

variable "ecodass_dedicated_network_acl" {
  description = "Whether to use dedicated network ACL (not default) and custom rules for ecodass subnets"
  type        = bool
  default     = false
}
...
variable "apps_inbound_acl_rules" {
  description = "Apps subnets inbound network ACL rules"
  type        = list(map(string))
...
variable "apps_outbound_acl_rules" {
  description = "Apps subnets outbound network ACL rules"
  type        = list(map(string))
...
variable "ecodass_inbound_acl_rules" {
...
variable "ecodass_outbound_acl_rules" {
...
variable "mgmt_subnet_ipv6_prefixes" {
  description = "Assigns IPv6 mgmt subnet id based on the Amazon provided /56 prefix base 10 integer (0-256). Must be of equal length to the corresponding IPv4 subnet list"
  type        = list
  default     = []
}

variable "mgmt_subnet_assign_ipv6_address_on_creation" {
  description = "Assign IPv6 address on mgmt subnet, must be disabled to change IPv6 CIDRs. This is the IPv6 equivalent of map_public_ip_on_launch"
  type        = bool
  default     = null
}

variable "mgmt_subnet_suffix" {
  description = "Suffix to append to mgmt subnets name"
  type        = string
  default     = "mgmt"
}

variable "mgmt_subnets" {
  description = "A list of mgmt subnets"
  type        = list(string)
  default     = []
}

variable "create_mgmt_subnet_route_table" {
  description = "Controls if separate route table for mgmt should be created"
  type        = bool
  default     = false
}

variable "enable_public_mgmt" {
  description = "Controls if mgmt should have public routing table"
  type        = bool
  default     = false
}

variable "mgmt_route_table_tags" {
  description = "Additional tags for the mgmt route tables"
  type        = map(string)
  default     = {}
}

variable "mgmt_subnet_tags" {
  description = "Additional tags for the mgmt subnets"
  type        = map(string)
  default     = {}
}

variable "mgmt_acl_tags" {
  description = "Additional tags for the mgmt subnets network ACL"
  type        = map(string)
  default     = {}
}

variable "mgmt_dedicated_network_acl" {
  description = "Whether to use dedicated network ACL (not default) and custom rules for mgmt subnets"
  type        = bool
  default     = false
}

variable "mgmt_inbound_acl_rules" {
  description = "mgmt subnets inbound network ACL rules"
  type        = list(map(string))
...
variable "mgmt_outbound_acl_rules" {
  description = "mgmt subnets outbound network ACL rules"
  type        = list(map(string))
...
variable "enable_flow_log" {
  description = "Should be true if you want to provision flow logs for the VPC"
  type        = bool
  default     = false
}

variable "flow_log_destination" {
  description = "Destination of VPC flow log"
  type        = string
  default     = ""
}
variable "flow_log_destination_type" {
  description = "Destination type of VPC flow log"
  type        = string
